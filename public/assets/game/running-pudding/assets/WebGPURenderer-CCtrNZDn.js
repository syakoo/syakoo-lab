...
class W {
  ...
  createGPUBuffer(e) {
    ...
    return (
      (e._updateID = 0),
      e.data && (oe(e.data.buffer, t.getMappedRange()), t.unmap()),
...
j.extension = { type: [f.WebGPUSystem], name: "stencil" };
const G = {
  i32: { align: 4, size: 4 },
  u32: { align: 4, size: 4 },
  f32: { align: 4, size: 4 },
...
K.extension = { type: [f.WebGPUSystem], name: "ubo" };
const b = 128;
class q {
  constructor(e) {
    ...
    for (let r = 0; r < t; r++) {
      ...
      r === 0 && (s |= P.COPY_SRC),
        this._buffers.push(new ae({ data: this._batchBuffer.data, usage: s }));
    }
  }
  renderEnd() {
...
q.extension = { type: [f.WebGPUPipes], name: "uniformBatch" };
const Re = {
  "point-list": 0,
  "line-list": 1,
  "line-strip": 2,
...
class Y {
  ...
  _createPipeline(e, t, r, s) {
    ...
    o[0].writeMask =
      this._stencilMode === C.RENDERING_MASK_ADD ? 0 : this._colorMask;
...
Y.extension = { type: [f.WebGPUSystem], name: "pipeline" };
class Le {
  constructor() {
    ...
    return (
      e.colorTextures.forEach((r, s) => {
        ...
        if (((t.msaa = r.source.antialias), r.source.antialias)) {
          const i = new ce({ width: 0, height: 0, sampleCount: 4 });
          t.msaaTextures[s] = i;
        }
      }),
      t.msaa &&
...
$.extension = { type: [f.WebGPUSystem], name: "renderTarget" };
class X {
  constructor() {
...
Z.extension = { type: [f.WebGPUSystem], name: "state" };
const De = {
    type: "image",
    upload(a, e, t) {
      const r = a.resource,
...
class ee {
  constructor(e) {
    (this.managedTextures = []),
      ...
      (this._uploads = { image: Q, buffer: De, video: Fe, compressed: ze }),
      (this._renderer = e),
...
ee.extension = { type: [f.WebGPUSystem], name: "texture" };
class te {
  init() {
    const e = new L({
      ...
      t = D({ name: "graphics", bits: [de, he(pe()), ge, H] });
    this.shader = new z({ gpuProgram: t, resources: { localUniforms: e } });
  }
  execute(e, t) {
    const r = t.context,
    ...
    for (let _ = 0; _ < u.instructionSize; _++) {
      ...
      if (
        ...
        const S = m.textures;
        (m.bindGroup = R(S.textures, S.count)),
...
te.extension = { type: [f.WebGPUPipesAdaptor], name: "graphics" };
class re {
  init() {
    const e = D({ name: "mesh", bits: [me, Pe, H] });
    this._shader = new z({
      gpuProgram: e,
      resources: {
...
re.extension = { type: [f.WebGPUPipesAdaptor], name: "mesh" };
const Ie = [...Te, K, N, v, W, ee, $, X, Z, Y, V, j, I],
  We = [...Ce, q],
  Ve = [O, re, te],
  se = [],
  ie = [],
