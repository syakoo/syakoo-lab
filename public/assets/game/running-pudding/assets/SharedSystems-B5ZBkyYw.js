...
const me = class A extends He {
  ...
  static from(e) {
    ...
    return (
      t && (n = te.from(t)),
      r && (i = re.from(r)),
      new A({ gpuProgram: n, glProgram: i, ...s })
    );
  }
};
me.defaultOptions = {
...
class rt extends Ze {
  constructor(e) {
    const { sprite: t, ...r } = e,
      ...
      i = te.from({
        vertex: { source: X, entryPoint: "mainVertex" },
        fragment: { source: X, entryPoint: "mainFragment" },
      }),
      o = re.from({ vertex: tt, fragment: et, name: "mask-filter" });
    super({
      ...r,
      gpuProgram: i,
      glProgram: o,
...
let ge = H;
D.handleByMap(u.Batcher, ge._availableBatchers);
D.add(ae);
const Bt = {
    name: "texture-bit",
    vertex: {
          ...
          ? (r.colorMask.setMask(0),
            n !== 0
              ...
              : (r.renderTarget.clear(null, B.STENCIL),
                r.stencil.setStencilMode(f.DISABLED, n)),
            n--)
          : e.action === "popMaskEnd" &&
            (e.inverse
              ? r.stencil.setStencilMode(f.INVERSE_MASK_ACTIVE, n)
...
class It {
  ...
  _initUniformGroup(e) {
    ...
    if (!r) {
      const s = Object.keys(e.uniformStructures).map(
          (o) => e.uniformStructures[o],
        ),
...
const S = [
  ...
  },
  {
    type: "vec4<f32>",
    test: (a) =>
      a.type === "vec4<f32>" && a.size === 1 && a.value.width !== void 0,
    ubo: `
            v = uv[name];
            data[offset] = v.x;
            data[offset + 1] = v.y;
  ...
  },
  {
    type: "vec4<f32>",
    test: (a) =>
      a.type === "vec4<f32>" && a.size === 1 && a.value.red !== void 0,
    ubo: `
            v = uv[name];
            data[offset] = v.red;
  ...
  },
  {
    type: "vec3<f32>",
    test: (a) =>
      a.type === "vec3<f32>" && a.size === 1 && a.value.red !== void 0,
    ubo: `
            v = uv[name];
            data[offset] = v.red;
            data[offset + 1] = v.green;
...
function Gt(a, e, t, r) {
  ...
  for (let o = 0; o < a.length; o++) {
    ...
    for (let p = 0; p < S.length; p++)
      if (S[p].test(l.data)) {
        (h = l.offset / 4),
          s.push(`name = "${d}";`, `offset += ${h - n};`, S[p][e] || S[p].ubo),
          (c = !0);
        break;
      }
    if (!c)
  ...
  constructor(e = {}) {
    ...
    this.colorTexture.source.on("resize", this.onSourceResize, this),
      (e.depthStencilTexture || this.stencil) &&
        ...
        e.depthStencilTexture instanceof T
  ...
  _addRenderableDirect(e, t) {
    this._renderer.renderPipes.batch.break(t),
      e._batchableRenderGroup &&
        (g.return(e._batchableRenderGroup), (e._batchableRenderGroup = null)),
      t.add(e);
  }
  ...
  _updateCachedRenderGroups(e, t) {
    ...
    if ((e.invalidateMatrices(), e.isCachedAsTexture)) {
      if (e.textureNeedsUpdate) {
        ...
        (e.texture = y.getOptimalTexture(r.width, r.height, i, o)),
  ...
  _updateRenderGroups(e) {
    ...
    if (
      ...
      e.structureDidChange
        ? E(e.childrenRenderablesToUpdate.list, 0)
        : ht(e, r),
      Me(e),
      e.structureDidChange
...
const L = class Be {
  constructor() {
    (this.clearBeforeRender = !0),
      (this._backgroundColor = new ce(0)),
...
z.extension = { type: [u.WebGLSystem, u.WebGPUSystem], name: "extract" };
z.defaultImageOptions = { format: "png", quality: 1 };
let mt = z;
class W extends m {
  static create(e) {
    return new W({ source: new T(e) });
  }
  resize(e, t, r) {
    ...
    n
      ? (n =
          Array.isArray(n) && n.length === 4
            ? n
            : ce.shared.setValue(n).toArray())
      : (n = xt);
    const i =
      ((d = e.frame) == null ? void 0 : d.copyTo(vt)) || $e(s, gt).rectangle;
...
class Ee {
  ...
  init() {
    Y.system.add(this._update, this);
  }
  repeat(e, t, r = !0) {
    const s = _t++;
    let n = 0;
...
function bt(a) {
  if (!ee) {
    if (
      he.get().getNavigator().userAgent.toLowerCase().indexOf("chrome") > -1
    ) {
      const e = [
        `%c  %c  %c  %c  %c PixiJS %c v${J} (${a}) http://www.pixijs.com/
...
`,
      ...
      globalThis.console &&
        globalThis.console.log(`PixiJS ${J} - ${a} - http://www.pixijs.com/`);
    ee = !0;
  }
}
class V {
  ...
  run() {
    ...
    for (let i = 0; i < t.length; i++) {
      ...
      const l = o.renderGroup ?? o.parentRenderGroup,
        d =
          ((n = l == null ? void 0 : l.instructionSet) == null
            ? void 0
            : n.gcTick) ?? -1;
      if (
...
j.extension = { type: [u.WebGLSystem, u.WebGPUSystem], name: "textureGC" };
j.defaultOptions = {
  textureGCActive: !0,
...
const $ = class Fe {
  ...
  init(e) {
    (e = { ...Fe.defaultOptions, ...e }),
      e.view &&
        (Ye(Je, "ViewSystem.view has been renamed to ViewSystem.canvas"),
        (e.canvas = e.view)),
      (this.screen = new w(0, 0, e.width, e.height)),
      (this.canvas = e.canvas || he.get().createCanvas()),
      (this.antialias = !!e.antialias),
      (this.texture = ye(this.canvas, e)),
...
$.defaultOptions = { width: 800, height: 600, autoDensity: !1, antialias: !1 };
let Mt = $;
const Ft = [pt, Ge, V, Mt, Pe, St, Ie, mt, Xe, Ct, Ee],
  Ht = [Ue, ge, Re, Se, xe, be, _e, Ce];
export {
  Ot as B,
  _ as G,
  Dt as R,
