...
B.extension = { type: [b.WebGLSystem, b.WebGPUSystem], name: "accessibility" };
B.defaultOptions = {
  enabledByDefault: !1,
  debug: !1,
  activateOnTab: !0,
...
class q {
  ...
  postrender() {
    ...
    this._domElement.parentNode !== t.parentNode &&
      ((i = t.parentNode) == null || i.appendChild(this._domElement)),
    ...
    for (let n = 0; n < e.length; n++) {
      ...
      if (!s.parent || s.globalDisplayStatus < 7)
        ...
        const r = s.worldTransform,
          ...
          d = s.width * l.x,
          p = s.height * l.y;
        (o.style.transformOrigin = `${d}px ${p}px`),
          (o.style.transform = `matrix(${r.a}, ${r.b}, ${r.c}, ${r.d}, ${r.tx - d}, ${r.ty - p})`),
    ...
    if (
      ...
      for (let u = p.length - 1; u >= 0; u--) {
        ...
        if (v) {
          ...
          (v.length > 0 || c) &&
            (c && this._allInteractiveElements.push(e), v.push(e)),
