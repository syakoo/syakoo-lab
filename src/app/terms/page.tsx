      ...
      <Container as="main" center paddingX="200" paddingY="400" size="100">
        ...
        <Col gap="300">
          ...
          <section>
            ...
            <Spacer y="100" />
            <P>
              当サイトで掲載しているコンテンツの著作権・肖像権等は、特に明記がない限り私（syakoo）に帰属します。フリー素材など外部のリソースについては、各権利者の利用規約に従って使用しています。許可なく無断利用（転載、複製、譲渡、二次利用等）することを禁止します。また、コンテンツの内容を変形・変更・加筆修正することも一切認めておりません。
            </P>
            <P>
