...
ee.extension = { type: [d.WebGLPipesAdaptor], name: "batch" };
var v = ((t) => (
...
class te {
  ...
  createGLBuffer(e) {
    ...
    e.descriptor.usage & B.INDEX
      ? (s = v.ELEMENT_ARRAY_BUFFER)
      : e.descriptor.usage & B.UNIFORM && (s = v.UNIFORM_BUFFER);
...
te.extension = { type: [d.WebGLSystem], name: "buffer" };
const P = class re {
  constructor(e) {
    (this.supports = {
      uint32Indices: !0,
...
ne.extension = { type: [d.WebGLSystem], name: "geometry" };
...
ae.extension = { type: [d.WebGLSystem], name: "colorMask" };
class oe {
  constructor(e) {
...
oe.extension = { type: [d.WebGLSystem], name: "encoder" };
class $e {
  constructor() {
    (this.width = -1),
      (this.height = -1),
...
class de {
  ...
  _createProgramData(e) {
    const r = e._key;
    return (
      (this._programDataHash[r] = at(this._gl, e)), this._programDataHash[r]
    );
  }
  destroy() {
...
function ut(t, e) {
  ...
  for (const s in t.uniforms) {
    ...
    if (!i) {
      const o = (n.size === 1 ? ot : ct)[n.type].replace(
        "location",
        `ud["${s}"].location`,
      );
      r.push(`
...
class Se {
  constructor(e) {
    (this.managedTextures = []),
      ...
      (this._uploads = { image: be, buffer: pt, video: vt, compressed: Rt }),
  ...
  contextChange(e) {
    (this._gl = e),
      this._mapFormatToInternalFormat ||
        ((this._mapFormatToInternalFormat = At(
          e,
...
class pe {
  init() {
    const e = new F({
      ...
      r = z(),
      s = q({ name: "graphics", bits: [Ne, ye(r), Q, Z] });
    this.shader = new U({
      glProgram: s,
      resources: { localUniforms: e, batchSamplers: De(r) },
    });
  }
  execute(e, r) {
    const s = r.context,
...
class ge {
  init() {
    const e = q({ name: "mesh", bits: [Q, Le, Z] });
    this._shader = new U({
      glProgram: e,
      resources: {
...
const Dt = [...He, _e, Ke, ke, te, Se, fe, ne, me, de, oe, bt, ce, ae],
  Ct = [...we],
  It = [ee, ge, pe],
  Re = [],
  ve = [],
